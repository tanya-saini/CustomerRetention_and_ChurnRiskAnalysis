...
End-to-end analysis of a UK online retailer's transaction data (Dec 2010 – Dec 2011): cleaning raw sales data, segmenting customers with RFM, and predicting future retention with a Logistic Regression model — surfaced in a Power BI dashboard.
...
## Tech Stack
Tool	Role
Python / Pandas / NumPy	Cleaning, aggregation, feature engineering
Jupyter Notebooks	Sequential analysis (00_project_setup → 07_retention_prediction)
Matplotlib / Seaborn	EDA visualizations
DuckDB (SQL)	Cross-validating Python aggregations, building time-windowed features
...
## RFM Segmentation (6 behavioral segments across 4,338 customers)
...
## Churn Prediction Model (Logistic Regression, 3 features, 664-customer holdout test set)
...
Strongest churn driver: order count (odds ratio 3.51) — customers who've already ordered more are far more likely to return; recency (OR 0.75) and tenure (OR 1.27) matter less
